  ...
  group "nextcloud" {
    ...
    service {
      ...
      tags = [
        ...
        "traefik.http.routers.nextcloud.middlewares=oauth2-proxy-errors@file,oauth2-proxy@file,nextcloud-ratelimit@file,nextcloud-sec@file,umami-tracking@file",
        ...
        "traefik.http.routers.nextcloud-http.middlewares=cf-tunnel-https@file,oauth2-proxy-errors@file,oauth2-proxy@file,nextcloud-ratelimit@file,nextcloud-sec@file,umami-tracking@file",
