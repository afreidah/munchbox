  ...
  group "vault-ui" {
    ...
    service {
      ...
      tags = [
        ...
        "traefik.http.routers.vault-ui.middlewares=oauth2-proxy-errors@file,oauth2-proxy@file",
        ...
        "traefik.http.routers.vault-ui-http.middlewares=cf-tunnel-https@file,oauth2-proxy-errors@file,oauth2-proxy@file",
        "vault-ui",
        "vault",
        "ui",
        "infrastructure"
