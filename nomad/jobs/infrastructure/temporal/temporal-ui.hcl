...
tags = [
  ...
  "ui",
  "monitoring",
  "traefik.http.routers.temporal-ui.middlewares=oauth2-proxy@file,umami-tracking@file",
  ...
  "traefik.http.routers.temporal-ui-http.middlewares=cf-tunnel-https@file,oauth2-proxy@file,umami-tracking@file"
]
