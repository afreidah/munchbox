...
tags = [
  ...
  "ui",
  "infrastructure",
  "traefik.http.routers.registry-ui.middlewares=oauth2-proxy-errors@file,oauth2-proxy@file",
  ...
  "traefik.http.routers.registry-ui-http.middlewares=cf-tunnel-https@file,oauth2-proxy-errors@file,oauth2-proxy@file"
]
