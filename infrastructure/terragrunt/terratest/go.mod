// Centralized terratest module for Munchbox terragrunt modules.
//
// One go.mod across every module's real-apply tests. Per-module tests live
// under subdirs (e.g. prometheus_alerts/). Shared helpers live under pkg/.
//
// See README.md for invocation; see infrastructure/terragrunt/STYLE_GUIDE.md
// for what plan-only vs terratest each cover.

module github.com/afreidah/munchbox/infrastructure/terragrunt/terratest
